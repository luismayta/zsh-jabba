...
:Version: 0.0.0
:Web: https://github.com/luismayta/zsh-jabba
:Download: https://github.com/luismayta/zsh-jabba
:Source: https://github.com/luismayta/zsh-jabba
:Keywords: zsh-jabba
...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-jabba``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-jabba )`` to your list of
   plugins
...
1. Add ``antibody bundle luismayta/zsh-jabba`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
   run ``antibody bundle luismayta/zsh-jabba`` in a
   running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-jabba.svg
   :target: https://travis-ci.org/luismayta/zsh-jabba
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-jabba.svg
   :target: https://github.com/luismayta/zsh-jabba/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/luismayta/zsh-jabba/readme
   :target: https://github.com/luismayta/zsh-jabba
